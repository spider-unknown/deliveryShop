        ...
        <div class="col-md-12 mb-5">
            <div class="card h-100">
                <header class="card-header">
                    <a href="{{route('category.index')}}" class="btn btn-outline-primary mt-1 mb-4"><i class="ti ti-arrow-left"></i> Назад</a>
                    <h2 class="h4 card-header-title">Продукты</h2>
                    <a href="{{route('product.create', ['category_id' => $category_id])}}" class="btn btn-outline-primary mt-3">
                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td class="d-inline-block">
                                        <a href="{{route('product.edit', ['id' => $product->id, 'category_id' => $category_id])}}"
